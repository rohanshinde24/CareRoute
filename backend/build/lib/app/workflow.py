...
ALLOWED_TRANSITIONS: dict[ReferralState, set[ReferralState]] = {
    ...
    ReferralState.MATCHING_PROVIDER: {ReferralState.PARSING, ReferralState.WAITING_FOR_SLOT_SELECTION, ReferralState.PROVIDER_UNAVAILABLE, ReferralState.CANCELLED},
